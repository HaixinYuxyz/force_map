...
def train(net, criterion, train_dataloader, valid_dataloader, device, batch_size, num_epoch, lr, lr_min, stats_dir,
    ...
    warm_up_with_multistep_lr = lambda epoch: epoch / (20 * 270) if epoch <= (20 * 270) else 0.4 ** len(
        [m for m in [40 * 270, 60 * 270, 80 * 270, 90 * 270] if m <= epoch])
