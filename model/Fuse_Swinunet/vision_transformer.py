...
class SwinUnet(nn.Module):
    ...
    def forward(self, rgb, inf):
        ...
        x.append(torch.cat((out, x_downsample_rgb[0], x_downsample_inf[0]), -1))
        out = self.cross_attention_1(tuple([x_downsample_rgb[1], x_downsample_inf[1]]))
        x.append(torch.cat((out, x_downsample_rgb[1], x_downsample_inf[1]), -1))
        out = self.cross_attention_2(tuple([x_downsample_rgb[2], x_downsample_inf[2]]))
        x.append(torch.cat((out, x_downsample_rgb[2], x_downsample_inf[2]), -1))
